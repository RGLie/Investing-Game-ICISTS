...
class _SocialPageState extends State<SocialPage> {
  ...
  _buildBody() {
    ...
    return StreamBuilder<DocumentSnapshot>(
        stream: FirebaseFirestore.instance.collection('trade_state').doc('open').snapshots(),
        builder: (context, snapshot) {
          ...
          return new StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                CollectionReference prices = FirebaseFirestore.instance
                    .collection('price');
                      ...
                      return Padding(
                        ...
                        child: StreamBuilder<DocumentSnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              Map<String, dynamic> name_data = snapshot.data
                                  ?.data();
                                        ...
                                        children: [
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment
                                                .spaceBetween,
                                            children: [
                                              Text('나의 자산', style: TextStyle(
                                                  fontSize: 20),),
                                              Text(
                                                '총 ${asset[widget.user.uid]}원',
                                                      ...
                                                      Text('1위',
                                                        style: TextStyle(
                                                            ...
                                                            color: Colors
                                                                .black),),
                                                      Text(
                                                        '${user_data[asset_order_uid[0]]['nick_name']}',
                                                        style: TextStyle(
                                                            fontSize: 20,
                                                            color: Colors
                                                                .black),),
                                                      Text(
                                                        '${user_data[asset_order_uid[0]]['asset']}원',
                                                        style: TextStyle(
                                                            fontSize: 20,
                                                            color: Colors
                                                                .black),)
                                                      ...
                                                      Text('2위',
                                                        style: TextStyle(
                                                            ...
                                                            color: Colors
                                                                .black),),
                                                      Text(
                                                        '${user_data[asset_order_uid[1]]['nick_name']}',
                                                        style: TextStyle(
                                                            fontSize: 20,
                                                            color: Colors
                                                                .black),),
                                                      Text(
                                                        '${user_data[asset_order_uid[1]]['asset']}원',
                                                        style: TextStyle(
                                                            fontSize: 20,
                                                            color: Colors
                                                                .black),)
                                                      ...
                                                      Text('3위',
                                                        style: TextStyle(
                                                            ...
                                                            color: Colors
                                                                .black),),
                                                      Text(
                                                        '${user_data[asset_order_uid[2]]['nick_name']}',
                                                        style: TextStyle(
                                                            fontSize: 20,
                                                            color: Colors
                                                                .black),),
                                                      Text(
                                                        '${user_data[asset_order_uid[2]]['asset']}원',
                                                        style: TextStyle(
                                                            fontSize: 20,
                                                            color: Colors
                                                                .black),)
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  mainAxisAlignment: MainAxisAlignment
                                                      .spaceBetween,
                                                  children: [
                                                    Text('4위', style: TextStyle(
                                                        fontSize: 20,
                                                        color: Colors.black),),
                                                    Text(
                                                      '${user_data[asset_order_uid[3]]['nick_name']}',
                                                      style: TextStyle(
                                                          fontSize: 20,
                                                          color: Colors
                                                              .black),),
                                                    Text(
                                                      '${user_data[asset_order_uid[3]]['asset']}원',
                                                      style: TextStyle(
                                                          fontSize: 20,
                                                          color: Colors.black),)
                                                  ],
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  mainAxisAlignment: MainAxisAlignment
                                                      .spaceBetween,
                                                  children: [
                                                    Text('5위', style: TextStyle(
                                                        fontSize: 20,
                                                        color: Colors.black),),
                                                    Text(
                                                      '${user_data[asset_order_uid[4]]['nick_name']}',
                                                      style: TextStyle(
                                                          fontSize: 20,
                                                          color: Colors
                                                              .black),),
                                                    Text(
                                                      '${user_data[asset_order_uid[4]]['asset']}원',
                                                      style: TextStyle(
                                                          fontSize: 20,
                                                          color: Colors.black),)
                                                  ],
